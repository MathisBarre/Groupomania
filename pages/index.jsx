...
export default function Home() {
  return (
    <div className="flex flex-1 bg-rose-700">
      {/* BACKGROUND */}
      <Image src={IndexBgImg} alt="" objectFit="cover" layout="fill" />
      ...
      <div className="z-10 flex flex-col items-center justify-center w-full max-w-xl mx-auto ">
        ...
        <Tabs />
        { process.env.NEXT_PUBLIC_DEMO_MODE && (<div className="mt-4 w-full px-4 py-6 bg-white sm:rounded-lg shadow sm:p-6">
